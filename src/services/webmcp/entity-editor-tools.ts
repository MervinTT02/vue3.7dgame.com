...
const createTools = (
  ...
  },
  {
    ...
    execute: (input) => {
      ...
      return buildEntityTree(options.getContext().entity, {
  ...
  },
  {
    ...
    execute: (input) => {
      ...
      return inspectEntityNode(options.getContext().entity, selector);
    },
  },
  {
    ...
    annotations: { readOnlyHint: true, untrustedContentHint: true },
    execute: () => validateEntity(options.getContext().entity),
  },
  {
